...
cat19Count = int(16)
''' Total mob count '''
mobCount = int(cat1Count + cat2Count + cat3Count + cat4Count + cat5Count + cat6Count + cat7Count + cat8Count + cat9Count + cat10Count + cat11Count + cat12Count + cat13Count + cat14Count + cat15Count + cat16Count + cat17Count + cat18Count + cat19Count)
...
if (catInfo == "M"): # Even if you type it lowercase, it will still count with the upper() method
	...
	print ("Category 19") # Category 18 mobs
