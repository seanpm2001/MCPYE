...
# Size: 090,.416 bytes (90,.41 Kilobytes (base 10)) -base 2 calculation not available- (when this file reaches 100.4 kilobytes in size, a megabyte conversion will be added here) -base 2 calculation not available-
# Lines: 01,.992
# Unicode characters used: None
# Written with: notepad++ (7.5.9 (64 bit))
# Software group: FOSS (Free Open Source Software)
# Last modified: August 17th 2019
