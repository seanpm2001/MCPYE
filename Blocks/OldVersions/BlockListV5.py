...
block_graniteStairsID = float(3.33)
block_polishedGraniteStairsID = float(3.34)
block_andesiteStairsID = float(3.35)
block_polishedAndesiteStairsID = float(3.36)
block_dioriteStairsID = float(3.37)
block_polishedDioriteStairsID = float(3.38)
block_chocolateStairsID = float(3.39)
''' Ores ''' # Category 5
...
# Size: 36,.286 bytes (36,.28 Kilobytes)
# Lines: 0,.913
